...
namespace Appala_poo.com.Controllers
{
    public class BrandController : Controller
    {
        ...
        public IActionResult Create(Brand brand)
        {
            ...
            if (file.Count > 0)
            {
                ...
                brand.BrandImage = @"\images\Brand\" + newFilename + extension;
        ...
        public IActionResult Edit(Brand brand)
        {
            ...
            if (file.Count > 0)
            {
                ...
                //delete old image
                var objFromDb = _dbContext.Brand.FirstOrDefault(x => x.Id == brand.Id);

                var oldImagePath = Path.Combine(webRootPath, objFromDb.BrandImage.Trim('\\'));
            ...
            if (ModelState.IsValid)
            {
                ...
                objFromDb.ManufacturingDate = brand.ManufacturingDate;
                objFromDb.ExpiredDate = brand.ExpiredDate;
                if (brand.BrandImage != null)
                {
                    objFromDb.BrandImage = brand.BrandImage;
                }
